    ...
    return (
      <div className="background py-10 text-center">
        ...
        <ol className="sm:w-1/2 py-10 sm:px-8 list-decimal text-left w-4/6 ml-6 sm:ml-0 sm:text-base text-xs">
          ...
          <li className="my-5">If not or you don't know how to pronounce it, at the left you will see set of words. Click it and you will hear the correct pronunciation of the word that you've clicked.</li>
          <li className="my-5">Keep going until all those words are all wiped out.</li>
          ...
          <h1 className="text-center"> - You can do it, blow them away!! - </h1>
        </ol>
